package com.hyd.frameworkproject.utils.immersion;
...
import com.hyd.frameworkproject.utils.immersion.base.AbstractImmersion;
 ...
 * 维护者
 */
public class ImmersionBarUtil extends AbstractImmersion {
     ...
     * @param activity
     */
    public ImmersionBarUtil(@NonNull Activity activity) {
     ...
     * @param fragment
     */
    public ImmersionBarUtil(@NonNull Activity activity, @NonNull Fragment fragment) {
     ...
     * @param dialogTag
     */
    public ImmersionBarUtil(@NonNull Activity activity, @NonNull Dialog dialog,
     ...
     * 软键盘监听回调
     */
    public void keyboardListener(OnKeyboardListener listener) {
     ...
     * @param isDarkFont     是否修改状态栏文字颜色 true = 黑色字,false = 白色字
     */
    public void statusBarColor2(@ColorRes int statusBarColor, boolean isDarkFont) {
        mImmersionBar.statusBarColor(statusBarColor)
                .statusBarDarkFont(isDarkFont, 0.2f)
                .init();
    }
